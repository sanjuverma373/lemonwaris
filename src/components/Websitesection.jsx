...
import wtrangle1 from '../assets/images/header-trangle1.webp'
import wtrangle2 from '../assets/images/header-trangle2.webp'
import wtrangle3 from '../assets/images/header-trangle3.webp'

const Websitesection = () => {
  return (
    <div id='contact' className=' pt-[45px] sm:pt-[106px]'>
      <div className=' max-w-[1220px] mx-auto px-3 bg-[#F7FAFE] rounded-[16px] relative '>
        <div className=' flex items-center justify-center flex-col h-[285px] sm:h-[432px]'>
                <h2 className=' font-poppins text-black text-[30px] sm:text-[64px] font-semibold leading-[40px] sm:leading-[88px] text-center max-w-[1024px] pb-[40px]'>We're here to make your website awesome.</h2>
                <button className=' bg-[#B00000] hover:shadow-[0_0_64px_0_rgba(176,0,0,0.30)] duration-300 border border-solid border-transparent hover:border hover:border-[#B00000]  hover:bg-transparent hover:text-[#B00000] group flex gap-[9px] px-[16px] py-[12px] rounded-[8px] text-[14px] font-poppins font-normal leading-[24px] text-white' > <svg className='group-hover:stroke-[green] transition-all duration-300' width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <img className=' absolute top-[0] left-[34%] w-[30px] sm:w-[40px]' src={wtrangle1} alt="#" />
        <img className=' absolute bottom-[20%] left-[-1%] w-[30px] sm:w-[40px]' src={wtrangle2} alt="#" />
        <img className=' absolute bottom-[10%] right-0 sm:right-[2%] w-[40px] sm:w-[72px]' src={wtrangle3} alt="#" />
